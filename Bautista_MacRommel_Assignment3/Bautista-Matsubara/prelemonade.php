  ...
  <table width="60%" height="587" >
    <tr>
      <th height="38" align="left" valign="bottom" bgcolor="#FFFFFF" scope="col"><div align="center">
        <h1><font color="#993300" face="Verdana, Arial, Helvetica, sans-serif"> MNC </h1>
      </div></th>
    </tr>
    <tr>
      ...
      <th height="480" bgcolor="#FFFFFF" scope="col"><table width='98%' height="98%" border='0' align='center' bgcolor='cccccc'>
        <tr>
          ...
          <td width="59%" align='top left' valign="top"><h2><font face="Verdana, Arial, Helvetica, sans-serif"> <font color="#993300"><br>
            Pre-Workout - Pink Lemonade </h2>
             <br>
			 <br>
			  <p align="left">Description:<br>
                              30 Servings <br><font color="#993300" face="Arial, Helvetica, sans-serif" style='text'> C4 Pre-Workout <br>
   Pink Lemonade Flavored <font color="#993300">.</p>
              <p align="left"><font color="white">Price: $29.99</p>
...
if (isset($_POST['addcart'])) {
	...
	if (!(is_numeric($quantity) && is_int($quantity - (int) $quantity) && $quantity >= 0)){
		$quantity_errors[]="<font color=red><b>*Please enter a valid quantity.</b>";
		show_product();
	}
	elseif($quantity==0){
		$quantity_errors[]="<font color=red><b>*Please enter a valid quantity.</b>";
		...
		if ($_SESSION['quantity8'] > 0) {
			$_SESSION['quantity8']+= $quantity;
		}
		else {
			$_SESSION['quantity8']=$quantity;
		}
