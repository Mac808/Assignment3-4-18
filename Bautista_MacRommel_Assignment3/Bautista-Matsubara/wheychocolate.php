      ...
      <th height="480" bgcolor="#FFFFFF" scope="col"><table width='98%' height="98%" border='0' align='center' bgcolor='cccccc'>
        <tr>
          ...
          <td width="59%" align='top left' valign="top"><h2><font face="Verdana, Arial, Helvetica, sans-serif"> 
            <br> Whey Protein - Double Chocolate </h2><Br>
			  <Br><p align="left">Description:<br>
  74 Servings  Gold Standard Whey Protein <br>
   Double Chocolate Flavored .</p>
              <p align="left"><font color="white">Price: $59.99</p>
...
if (isset($_POST['addcart'])) {
	...
	if (!(is_numeric($quantity) && is_int($quantity - (int) $quantity) && $quantity >= 0)){
		...
		if ($_SESSION['quantity7'] > 0) {
			$_SESSION['quantity7']+= $quantity;
		}
		else {
			$_SESSION['quantity7']=$quantity;
		}
