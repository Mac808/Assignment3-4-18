...
{
$last = $_COOKIE[$time];
echo "	<h1><center>Welcome back {$_SESSION['username']}! </h1><br>
...
{
echo "<center><h1>Welcome to our site {$_SESSION['username']}!
...
echo "<br><br>Cart Contents: $items_in_cart item(s)";
