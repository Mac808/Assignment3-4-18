        ...
        <tr>
          ...
          <td width="59%" align='top left' valign="top"><h2><font face="Verdana, Arial, Helvetica, sans-serif"> <font color="#993300">
            <br> Whey Protein - Mocha Cappuccino </font></font></h2><Br>
			  <Br><p align="left"><font color="#993300" face="Arial, Helvetica, sans-serif">Description:
                          <br>One dozen </font><font color="#993300" face="Arial, Helvetica, sans-serif" style='text'> Gold Standard Whey Protein <br>
  </font><font color="#993300" face="Arial, Helvetica, sans-serif"> Mocha Cappuccino Flavored </font><font color="#993300">
  </font></p>
              <p align="left"><font color="#CC3300">Price: $64.99</font></p>
			  <table width="100%" height="160" >
                <tr>
                  <th scope="col"><p>&nbsp;</p>
					...
					Quantity: <input type='text' name='quantity3' value='<?php echo $quantity3; ?>'  size='2'>
    ...
    if (isset($_POST['addcart'])) 
{
	...
	if (!(is_numeric($quantity3) && is_int($quantity3 - (int) $quantity3) && $quantity3 >= 0))
        {
		...
		if ($_SESSION['quantity3'] > 0) 
                {
			$_SESSION['quantity3']+= $quantity3;
		}
		else 
                {
			$_SESSION['quantity3']=$quantity3;
