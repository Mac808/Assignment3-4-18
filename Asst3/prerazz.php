          ...
          <td width="59%" align='top left' valign="top"><h2><font face="Verdana, Arial, Helvetica, sans-serif"> <font color="#993300"><br>
            Pre-Workout - Icy Blue Razz </font></font></h2>
			 ...
			 <br>
              ...
              <p align="left"><font color="#CC3300">Price: $34.99</font></p>
			  <table width="100%" height="160" >
                <tr>
                  <th scope="col"><p>&nbsp;</p>
					...
					Quantity: <input type='text' name='quantity8' value='<?php echo $quantity8; ?>'  size='2'>
...
{
	$quantity8 = trim($_POST['quantity8']);
	if (!(is_numeric($quantity8) && is_int($quantity8 - (int) $quantity8) && $quantity8 >= 0))
        {
