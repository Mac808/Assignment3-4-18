			  ...
			  <table width="100%" height="160" >
                <tr>
                  <th scope="col"><p>&nbsp;</p>
					...
					Quantity: <input type='text' name='quantity6' value='<?php echo $quantity6; ?>'  size='2'>
...
if (isset($_POST['addcart'])) 
{
	...
	if (!(is_numeric($quantity6) && is_int($quantity6 - (int) $quantity6) && $quantity6 >= 0))
        {
