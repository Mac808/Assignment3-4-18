          ...
          <td width='41%' height="465"><table width="100%" height="274" >
            <tr>
              <th bgcolor="#FFFFFF" scope="col"><table width="100%" height="95%" >
                <tr>
                  <th bgcolor="#CCCCCC" scope="col"><img src='./pbcupcookies.jpg'></th>
                </tr>
              </table></th>
            </tr>
          </table>
		  <a href="./peanutbutter.php"><--Previous Product</a> &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
		  &nbsp; &nbsp; &nbsp;<a href="./peanutcandy.php">Next Product--> </a>
		  </td>
          <td width="59%" align='top left' valign="top"><h2><font face="Verdana, Arial, Helvetica, sans-serif"> <font color="#993300"><br>
            Peanut Butter cup  </font></font></h2>
             <br>
			 <br>
			  <p align="left"><font color="#993300" face="Arial, Helvetica, sans-serif">Description:<br>
  Two dozen (24 pcs) </font><font color="#993300" face="Arial, Helvetica, sans-serif" style='text'>Delicious Peanut Butter<br>
  </font><font color="#993300" face="Arial, Helvetica, sans-serif"> cup cookies </font><font color="#993300">.</font></p>
