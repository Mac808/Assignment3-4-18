			  ...
			  <table width="100%" height="160" >
                <tr>
                  <th scope="col"><p>&nbsp;</p>
					...
					Quantity: <input type='text' name='quantity9' value='<?php echo $quantity9; ?>'  size='2'>
...
{
	$quantity9 = trim($_POST['quantity9']);
	if (!(is_numeric($quantity9) && is_int($quantity9 - (int) $quantity9) && $quantity9 >= 0))
        {
