			  ...
			  <table width="100%" height="160" >
                <tr>
                  <th scope="col"><p>&nbsp;</p>
					...
					Quantity: <input type='text' name='quantity5' value='<?php echo $quantity5; ?>'  size='2'>
...
if (isset($_POST['addcart'])) 
{
	...
	if (!(is_numeric($quantity5) && is_int($quantity5 - (int) $quantity5) && $quantity5 >= 0))
        {
