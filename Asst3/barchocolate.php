...
<div align="center">
  ...
  One Dozen (12) </font><font color="#993300" face="Arial, Helvetica, sans-serif" style='text'> Pure Protein Bars - Chocolate Deluxe </font></p>
              <p align="left"><font color="#CC3300">Price: $22.99</font></p>
			  <table width="100%" height="160" >
                <tr>
                  <th scope="col"><p>&nbsp;</p>
					...
					Quantity: <input type='text' name='quantity4' value='<?php echo $quantity4; ?>'  size='2'>
...
if (isset($_POST['addcart'])) 
{
	...
	if (!(is_numeric($quantity4) && is_int($quantity4 - (int) $quantity4) && $quantity4 >= 0))
        {
