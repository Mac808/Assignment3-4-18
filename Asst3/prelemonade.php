			  ...
			  <table width="100%" height="160" >
                <tr>
                  <th scope="col"><p>&nbsp;</p>
					...
					Quantity: <input type='text' name='quantity7' value='<?php echo $quantity7; ?>'  size='2'>
...
{
	$quantity7 = trim($_POST['quantity7']);
	if (!(is_numeric($quantity7) && is_int($quantity7 - (int) $quantity7) && $quantity7 >= 0))
        {
